-- Database Backup
-- Date: 2026-01-10 10:04:51
-- Database: distribution
-- Tables: 19

SET FOREIGN_KEY_CHECKS=0;

-- Table: assignment_cancellations
...
-- Data for table `assignment_cancellations`
...
-- Table: attendance_confirmations
...
-- Data for table `attendance_confirmations`
...
-- Data for table `distribution_items`
...
CREATE TABLE `distribution_log` (
  ...
  `status` enum('completed','skipped','partial','in_transit') COLLATE utf8mb4_unicode_ci DEFAULT 'completed',
...
-- Data for table `distribution_log`
...
-- Data for table `distribution_resources`
...
-- Data for table `distribution_tracking`
...
-- Data for table `distribution_volunteer`
...
-- Data for table `shelter_coordinates`
...
-- Data for table `victim_approvals`
...
-- Data for table `victim_coordinates`
...
-- Data for table `volunteer_alerts`
...
-- Table: volunteer_distribution_assignments
...
-- Data for table `volunteer_distribution_assignments`
